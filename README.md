...
- **170×32 박스 안에 맞춰 축소합니다.** 한 변만 맞추면 모양이 다른 로고끼리 무게가
  안 맞습니다 — 높이만 24px로 고정했더니 6.67:1 워드마크는 160px 폭인데 정사각
  크레스트는 24px에 갇혔습니다. 양쪽을 다 제한하면 가로로 긴 건 폭 예산을,
  정사각형은 높이 예산을 써서 비슷한 무게로 읽힙니다.
